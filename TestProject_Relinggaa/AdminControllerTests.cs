...
public class AdminControllerTests
{
    ...
    [TestMethod]
    public void GetAllKendaraan_ReturnsOk()
    {
    ...
    [TestMethod]
    public void GetKendaraanByPlatNomor_Existing_ReturnsOk()
    {
        var platNomor = "AB 123 CD";
    ...
    [TestMethod]
    public void GetKendaraanByPlatNomor_NotExisting_ReturnsNotFound()
    {
        var platNomor = "ZZ 999 ZZ";
    ...
    [TestMethod]
    public void AddKendaraan_ReturnsCreatedAtAction()
    {
    ...
    [TestMethod]
    public void UpdateKendaraan_Existing_ReturnsOk()
    {
        var platNomor = "AB 123 CD";
        var updatedKendaraan = new Kendaraan { Merek = "Toyota Updated", PlatNomor = platNomor };
    ...
    [TestMethod]
    public void UpdateKendaraan_NotExisting_ReturnsNotFound()
    {
        var platNomor = "ZZ 999 ZZ";
        var updatedKendaraan = new Kendaraan { Merek = "INNOVA", PlatNomor = platNomor };
    ...
    [TestMethod]
    public void DeleteKendaraan_Existing_ReturnsNoContent()
    {
        var platNomor = "EF 456 GH";
    ...
    [TestMethod]
    public void DeleteKendaraan_NotExisting_ReturnsNotFound()
    {
        var platNomor = "ZZ 999 ZZ";
